...
Based on the formula above, the likelihood of a customer with those paramaters defaulting would be __`r round((1/(1+exp(-(spend/15000 - age/99)))) * 100,digits=2)`%__.
